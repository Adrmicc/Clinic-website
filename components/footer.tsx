          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="#zabiegi" className="text-background/80 hover:text-background transition-colors">
                    Zabiegi
                  </a>
                </li>
                <li>
                  <a href="#cennik" className="text-background/80 hover:text-background transition-colors">
                    Cennik
                  </a>
                </li>
                <li>
                  <a href="#o-nas" className="text-background/80 hover:text-background transition-colors">
                    O nas
                  </a>
                </li>
                <li>
